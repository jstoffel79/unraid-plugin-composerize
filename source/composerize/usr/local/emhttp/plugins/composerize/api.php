...
// Sanitize the stack name to prevent security issues.
...
try {
    ...
    if ($status) {
        ...
        // This handles the case where the stack exists and force=false.
    ...
    // Log the detailed error to the Unraid system log
